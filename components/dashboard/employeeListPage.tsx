...
import EmployeeForm from "@/components/dashboard/employees/employeeForm"; // Ensure this uses default import
import { Employee } from "@/type/Employee"; // Your Employee type
import { getToken } from "next-auth/jwt"; // Get token function

import {CirclePlus} from "lucide-react"; // Icons
...
const EmployeeListPage = () => {
  ...
  return (
    <div className="p-4">
      ...
      >
        <span>Add Employee</span> <CirclePlus className="w-5 h-5" />
      </Button>
